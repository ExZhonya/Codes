...
class map2:
    def city():
      while True:
        preset.area("You're in City", "[0]Guild, [1]Village, [2]Shop, [3]Blacksmith [4]City Sewers, [5]Dark Forest")
        choice = input()
        if choice == "0":
    ...
    def city_shop():
        while True:
            preset.area("You're in City Shop", "[1]Weapon, [2]Armor, [3]Potion, [4]Back")
            choice = input()
            if choice == "1":
                map1.vil_weap()
            elif choice == "2":
...
class map3:
    def castle():
        while True:
            preset.area("You're in Castle", "[0]Guild, [1]City, [2]Shop, [3]Blacksmith [4]Sewers")
            choice = input()
            if choice == "0":
            	pass #city guild
            elif choice == "1":
